...
3. 選択肢を提示して選んでもらう: テーマ追加 / テーマ一覧・編集 / バックボーン修正 / 画像テイスト変更 / ロゴ設定 / 誘導先・読者・ゴール変更 / テーブル構成確認・再作成 / 設定一覧表示 / 拡張機能の導入手順。
4. 選ばれた項目に応じ `engine/theme_prompt.md` または `engine/setup_prompt.md` の該当セクションを実行する。
